package com.youjia.newsway.review;
...
public class BusLineView extends View {
    ...
    private void init(Context context) {
        ...
        mColorPass = Color.parseColor("#dcdcdc");
        mColorUnreach = Color.parseColor("#000000");
        mSelectedColor = Color.parseColor("#7fffd4");
        ...
        mStationNameTxtSize = 15 * scaleDensity;
